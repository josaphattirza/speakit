...
function Listening({route, navigation}){
    const { readingScore } = route.params;
    ...
    function handleAnswerOptionClick(isCorrect){
        ...
        if (nextQuestion < questions.length) {
            ...
            readingScore: readingScore, listeningScore: listeningScore
            });
            // setShowScore(true);
        }
    };
    ...
    <View style={[styles.container, {flexDirection: "column"}]}>
        {/* Progress Bar */}
            ...
            <Text>You scored {listeningScore} out of {questions.length}</Text>
            </View>
